<?php /* SVG sprite — included once at top of header.php. Reference icons with <svg><use href="#icon-x"/></svg> */ ?>
<svg xmlns="http://www.w3.org/2000/svg" style="display:none" aria-hidden="true">
  <defs>
    ...
    <symbol id="icon-trending-down" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <path d="M23 18l-9.5-9.5-5 5L1 6" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M17 18h6v-6" stroke-linecap="round" stroke-linejoin="round"/>
    </symbol>
    <!-- lightning / breaking -->
    <symbol id="icon-breaking" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <!-- newspaper -->
    <symbol id="icon-newspaper" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <path d="M4 22h16a2 2 0 002-2V4a2 2 0 00-2-2H8a2 2 0 00-2 2v16a2 2 0 01-2 2zm0 0a2 2 0 01-2-2v-9c0-1.1.9-2 2-2h2"/>
      <path d="M18 14h-8M15 18h-5M10 6h8v4h-8z" stroke-linecap="round"/>
    </symbol>
    <!-- home -->
    ...
    <symbol id="icon-whatsapp" viewBox="0 0 24 24" fill="currentColor">
      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.47-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.445-.52.15-.174.2-.298.3-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378L2 21l1.652-6.03a9.864 9.864 0 01-1.321-4.97C2.333 4.814 6.9.25 12.51.25c2.697 0 5.23 1.05 7.13 2.957a10.03 10.03 0 012.95 7.14c-.003 5.56-4.57 10.096-10.14 10.096"/>
    </symbol>
    <!-- rss -->
    <symbol id="icon-rss" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
